...
| **Клиенты** | Портрет + **истории аудитории** (поведение/сигнал); Отзывы/Интервью уже есть; evidence pack: [`reports/evidence-pack-clients.md`](reports/evidence-pack-clients.md) | Mom Test + Ries (архетип как история) |
