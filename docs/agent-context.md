...
Кратко v2: A–D ✅; группа **Other** (мини-гайды + Интервью + лёгкий Mom Test в Отзывах) ✅ — issue #17. Группа **Бизнес** (клиенты / MVP / оффер / конкуренты / must-have) — issue **#24** (в работе). Группа **Активность** — #22. Пакеты E–J в roadmap — справочная карта идей, не жёсткая очередь (см. #20).
...
| **Бизнес** (E+G+конкуренты) | Клиенты, MVP/оффер, must-have, альтернативы | #24 | Mom Test + Olsen + Cagan |
| **E** | Клиенты (+ Feedback) | частично → закрывается в #24 / #19 | Mom Test |
| **F** / **Активность** | Идеи / задачи / цели / рефлексия (+ аналитика) | #22 | Ries + Cagan |
| **G** | Твой продукт, оффер, must-have | в #24 | Olsen + Cagan |
| **H** | Календарь + кампании как learning launches | не начат | Knapp + Ries |
| **I** | Позиционирование + конкуренты | конкуренты в #24; бренд — отдельно | Cagan |
