...
Полный операционный чеклист команды (манифест, типы изменений, DoD): [`delivery-checklist-git-to-notion.md`](delivery-checklist-git-to-notion.md).
...
2. Перенос в Notion — **точечно по страницам** (не «весь космос заново»):
   ...
   - Твой продукт
   - треки Быстрый старт
   - и т.д. по чеклисту из отчётов пакетов / манифесту поставки
