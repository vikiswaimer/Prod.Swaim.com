...
3. Сделайте шаг «сегодня» из шапки выбранного трека. Для Старта это обычно [Твой продукт](../Бизнес/Твой%20продукт--5ac1cda1.md) (чистый шаблон) — при необходимости сверка с [примером заполнения](../examples/твой-продукт-пример.md).
