...
4. Не отдавайте ИИ секреты: пароли, ключи API, персональные данные клиентов. Секреты — во внешнем менеджере паролей; базовые принципы и понятия — в разделе «Цифровая безопасность» (дополнительные материалы).
...
2. На домашней странице выберите **один** трек в **Быстрый старт**: [«Старт своего бизнеса»](../Быстрый%20старт/Старт%20своего%20бизнеса--66c3ee00.md) или [«Развитие своего бизнеса»](../Быстрый%20старт/Развитие%20своего%20бизнеса--d23a7834.md). Не заполняйте все разделы сайдбара «на всякий случай».
3. Сделайте **одно** действие из шапки выбранного трека. Для Старта — [Твой продукт](../Бизнес/Твой%20продукт--5ac1cda1.md) (при необходимости сверка с [примером](../examples/твой-продукт-пример.md)); для Развития — одна [цель](../Активность/Цели--864823f3.md) на период.
