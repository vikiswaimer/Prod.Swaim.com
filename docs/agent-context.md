...
| **Клиенты** | Портрет + **истории аудитории** (поведение/сигнал); JTBD/outcome stories ядра Старт+Клиенты — `docs/reports/jtbd-start-clients-core.md` (SWA-4); Отзывы/Интервью уже есть | Mom Test + Ries + JTBD (расширение) |
