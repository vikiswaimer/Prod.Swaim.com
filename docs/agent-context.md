...
## Карта рисков и гипотез

Актуальный снимок для product-решений: [`docs/risk-map-hypotheses.md`](risk-map-hypotheses.md) (SWA-3). Обновлять после интервью и циклов проверки.
