...
| Активность | Lean-ритм: цели, банк идей, задачи (или Linear/GitHub), аналитика, рефлексия; календарь; заметки опционально — #22 |
...
Кратко v2: A–D ✅; группа **Other** ✅ #17; **E** частично (остаток Клиенты); **F / Активность** — issue **#22** (банк идей, аналитика, Lean-ритм). Дальше по группам в диалоге; справочно: G MVP → H launches → I позиционирование; J — INDEX/демо.
...
| **F** | Активность: банк идей, задачи, цели, аналитика, рефлексия | Git #22 | Ries + Cagan |
