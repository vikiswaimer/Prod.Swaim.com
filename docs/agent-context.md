...
Кратко v2: A–D ✅; группа **Other** (мини-гайды + Интервью + лёгкий Mom Test в Отзывах) ✅ — issue #17. Пакет **E** частично закрыт (Отзывы/Интервью); остаток — **Клиенты** + CSV портрета. Дальше: **F** lean Activity → **G** MVP/оффер → **H** sprint launches → **I** позиционирование/конкуренты; **J** — INDEX/демо (частично после Other; можно параллелить после E).
...
| **F** | Идеи / задачи / цели / рефлексия (схемы CSV) | не начат | Ries + Cagan |
