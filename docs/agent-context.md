...
| Активность | Lean-ритм: цели, гипотезы, задачи (или Linear/GitHub), аналитика, рефлексия; календарь; заметки опционально — #22 |
...
Кратко v2: A–D ✅; группа **Other** ✅ #17; **E** частично (остаток Клиенты); **F / Активность** — issue **#22** (гипотезы вместо идей, аналитика, Lean-ритм). Дальше по группам в диалоге; справочно: G MVP → H launches → I позиционирование; J — INDEX/демо.
...
Черновики тел: [`docs/issue-drafts/`](issue-drafts/README.md). Актуальные статусы — в [`roadmap-v2.md`](roadmap-v2.md).

| Пакет | Фокус | Статус | Школы |
|-------|--------|--------|--------|
| **Other** (вне E–J) | Мини-гайды + Интервью | ✅ #17 | Cagan + Mom Test (без названия книги в UI) |
| **E** | Клиенты (+ добить CSV отзывов) | частично — остаток Клиенты | Mom Test |
| **F** | Активность: гипотезы, задачи, цели, аналитика, рефлексия | Git #22 | Ries + Cagan |
| **G** | Твой продукт, оффер, must-have до ценного среза | тонкий задел (A) | Olsen + Cagan |
| **H** | Календарь + кампании как learning launches | не начат | Knapp + Ries |
| **I** | Позиционирование + конкуренты через outcomes | не начат | Cagan |
| **J** | INDEX, демо-шум, точечный язык | частично | доверие к шаблону |
