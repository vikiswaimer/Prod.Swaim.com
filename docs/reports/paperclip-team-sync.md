...
### SWA-9 closed — WIP=1 после risk-map

Paperclip **SWA-9** (continuation wake): risk-map дал пул W1–W3; PL обязан выбрать **один** ACTIVE.

| Решение | Деталь |
|---------|--------|
| **ACTIVE** | W1 Mom Test (valuable / H4·H1·H5) |
| **HOLD** | W2 #22 · W3 smoke-оффер |
| Proof | [`swa9-wip1-after-risk-map.md`](swa9-wip1-after-risk-map.md) |
| Исполнение | PRO-2 / PRO-3 + [`w1-mom-test-brief.md`](w1-mom-test-brief.md) |

На доске Paperclip (когда API жив): SWA-9 → **`done`**. Не открывать новый feature-прогон «вместо» закрытия.
...
| SWA-9 | Product Lead | этот PR | `docs/reports/swa9-wip1-after-risk-map.md` | ✅ WIP=1 = W1; тикет закрыт решением |
...
| 2026-08-15 | SWA-9: формально WIP=1 после risk-map = W1; тикет → done |
